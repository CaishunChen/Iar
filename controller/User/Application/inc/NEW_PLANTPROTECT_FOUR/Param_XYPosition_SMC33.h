...
double PKlp[5]= 
    { -0.1362630826, -0.3597142601, -0.0878724061, -0.3091612377, -0.0477383618};

double PKnp= -3.4971610178; 
...
double PSr[4]= 
    {  0.0351323582,  0.0933530633,  0.0254188171,  0.0838532881};
