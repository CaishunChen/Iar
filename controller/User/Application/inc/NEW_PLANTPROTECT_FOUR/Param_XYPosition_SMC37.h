...
double PKlp[5]= 
    { -0.1315046874, -0.3586826355, -0.0039467217, -0.0472108543, -0.0052991664};

double PKnp= -0.6783243523; 
...
double PSr[4]= 
    {  0.1811279707,  0.4602451722,  0.1486204948,  0.0669951851};
