...
double PKlp[5]= 
    { -0.1063128913, -0.1936100514, -0.0077217066, -0.0317926203, -0.0056170764};

double PKnp= -2.5120329238; 
...
double PSr[4]= 
    {  0.0489099933,  0.0941946730,  0.0080673404,  0.0119107760};
