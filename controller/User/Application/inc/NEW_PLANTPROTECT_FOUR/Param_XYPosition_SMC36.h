...
double PKlp[5]= 
    { -0.1443064729, -0.4352458673, -0.0167176965, -0.0956477354, -0.0013289492};

double PKnp= -0.5943241371; 
...
double PSr[4]= 
    {  0.2067281232,  0.5899152378,  0.2274095571,  0.1601899475};
