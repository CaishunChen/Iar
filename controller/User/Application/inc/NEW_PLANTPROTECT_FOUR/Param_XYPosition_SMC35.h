...
double PKlp[5]= 
    { -0.1399986415, -0.3563174071,  0.0043404385, -0.0130168051, -0.0023638424};

double PKnp= -1.0571424604; 
...
double PSr[4]= 
    {  0.1162222860,  0.3194246594,  0.0716559237,  0.0115678426};
