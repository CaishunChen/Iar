...
{ 
    {  0.9231064071, -0.0000162051}, 
    {  0.0189460400,  0.9995518418} 
};

double Ublox_Alt_V2PKalman_B[2][2] = 
{ 
    {  0.0192209134, -0.0000056648}, 
    {  0.0001947716, -0.0001566614} 
};

double Ublox_Alt_V2PKalman_C[1][2] = 
    { -1.7537648469, -2.8593681269};

double Ublox_Alt_V2PKalman_D[1][2] = 
    {  0.0000000000,  0.0004585879};
