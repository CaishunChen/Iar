...
double PKlp[5]= 
    { -0.0884196293, -0.3087919177, -0.0155609057, -0.1482974925, -0.0296703756};

double PKnp= -0.1803209437; 
...
double PSr[4]= 
    {  0.5087768363,  2.3878050013,  0.1387293853,  0.7675612408};
