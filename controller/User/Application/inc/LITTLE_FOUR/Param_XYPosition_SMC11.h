...
double PKlp[5]= 
    {  0.0437325822,  0.0873309203, -0.0009666492, -0.0110521482, -0.0010626317};

double PKnp= -0.1062631704; 
...
double PSr[4]= 
    {  0.5755717553,  0.7895977241,  0.0173172496,  0.0990073263};
