...
// 14-Mar-2017 11:17:31
//
///////////////////////////////////////////////////////////////////////////////
/*
CtrData.RefModel.Am = { 
    { -15.7058241680, -15.0000000000,  0.0000000000}, 
...
{ 
    {  0.7304339398,  0.0000000000,  0.0000000000}, 
    {  0.0171634457,  1.0000000000,  0.0000000000}, 
    {  0.0001806053,  0.0200000000,  1.0000000000} 
};

double Ublox_Alt_B_d[3] = 
    {  0.0064569006,  0.0000679438,  0.0000004646};

double Ublox_Alt_F[3] = 
    {  0.0000000000, 39.8723320912,  0.0000000000};

double Ublox_Alt_Br= 39.8723320912; 

double Ublox_A_refmodel_Alt[3][3] = 
{ 
    {  0.7279952294, -0.2571947332,  0.0000000000}, 
    {  0.0171463155,  0.9972922465,  0.0000000000}, 
    {  0.0001805169,  0.0199814823,  1.0000000000} 
};

double Ublox_B_refmodel_Alt[3] = 
    {  0.2571947332,  0.0027077535,  0.0000185177};
...
double Ublox_Klp_Alt[4]= 
    { -17.5433276837, -303.2316862947, -161.2204158120,  1.2097741859};

double Ublox_Knp_Alt = -1.9128209410; 

double Ublox_K1_Alt[3]= 
    {  0.0000000000, -39.8723320912,  0.0000000000};

double Ublox_K2_Alt = 39.8723320912; 

double Ublox_S_Alt[4]= 
    {  6.9482600691, 85.5027638008, 42.1420563620, -0.3162277660};
