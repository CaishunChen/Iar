...
CtrData.A2PKalmanParam.Qk =    {  0.2000000000};
...
{ 
    {  1.0000000000, -0.0088600813,  0.0199998000}, 
    {  0.0200000000,  0.9810857983,  0.0001999987}, 
    {  0.0000000000,  0.0000000000,  0.9999800002} 
};

double Ublox_Alt_A2PKalman_B[3][2] = 
{ 
    {  0.0200000000,  0.0088600813}, 
    {  0.0002000000,  0.0189142017}, 
    {  0.0000000000,  0.0000000000} 
};

double Ublox_Alt_A2PKalman_C[2][3] = 
{ 
    {  1.0000000000, -0.0088600813,  0.0000000000}, 
    {  0.0000000000,  0.9812629999,  0.0000000000} 
};

double Ublox_Alt_A2PKalman_D[2][2] = 
{ 
    { -0.0000000000,  0.0088600813}, 
    { -0.0000000000,  0.0187370001} 
};
