...
{ 
    {  0.9231153484, -0.0000016271}, 
    {  0.0191334407,  0.9998573830} 
};

double Ublox_Alt_V2PKalman_B[2][2] = 
{ 
    {  0.0192209134, -0.0000005688}, 
    {  0.0001947716, -0.0000498542} 
};

double Ublox_Alt_V2PKalman_C[1][2] = 
    { -1.7543174025, -2.8602690228};

double Ublox_Alt_V2PKalman_D[1][2] = 
    {  0.0000000000,  0.0001436641};
