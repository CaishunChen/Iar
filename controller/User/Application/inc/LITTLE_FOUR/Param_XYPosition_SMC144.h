...
double PKlp[5]= 
    { -0.1423215376, -0.7589808208, -0.0697502081, -0.9285871057, -0.2718119216};

double PKnp= -0.0780419065; 
...
double PSr[4]= 
    {  1.1195830958,  7.7549154605,  1.1509063998, 10.7376045671};
