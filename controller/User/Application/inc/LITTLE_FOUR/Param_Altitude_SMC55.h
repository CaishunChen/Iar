...
// 23-Feb-2017 11:46:54
//
///////////////////////////////////////////////////////////////////////////////
/*
CtrData.RefModel.Am = { 
    { -9.8172796057, -15.0000000000,  0.0000000000}, 
...
double Ublox_Alt_F[3] = 
    {  0.0000000000, 78.5347094437,  0.0000000000};

double Ublox_Alt_Br= 78.5347094437; 

double Ublox_A_refmodel_Alt[3][3] = 
{ 
    {  0.8190947684, -0.2721125919,  0.0000000000}, 
    {  0.0181408395,  0.9971884616,  0.0000000000}, 
    {  0.0001874359,  0.0199809500,  1.0000000000} 
};

double Ublox_B_refmodel_Alt[3] = 
    {  0.2721125919,  0.0028115384,  0.0000190500};
...
double Ublox_Klp_Alt[4]= 
    { -39.2631722739, -334.0334086775, -297.1756455691,  -2.1457379246};

double Ublox_Knp_Alt = -3.3927095517; 

double Ublox_K1_Alt[3]= 
    {  0.0000000000, -78.5347094437,  0.0000000000};

double Ublox_K2_Alt = 78.5347094437; 

double Ublox_S_Alt[4]= 
    {  7.7160264037, 56.4541587658, 43.7962108221, -0.3162277660};
