...
double error_Alt[4]; 
double Klp_Alt[4]= 
    { -69.5167950133, -566.9073366363, -1160.0193151248, -111.4154008816};

double Knp_Alt= -0.8942344818; 
...
double S_Alt[4]= 
    { 81.0580233018, 680.5033282943, 1866.2933975882, 155.7413116350};
